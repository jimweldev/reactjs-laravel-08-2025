...
// Component Props
type DeleteSystemGlobalDropdownDialogProps = {
  open: boolean;
  setOpen: (value: boolean) => void;
  refetch: () => void;
};

const DeleteSystemGlobalDropdownDialog = ({
  open,
  setOpen,
  refetch,
}: DeleteSystemGlobalDropdownDialogProps) => {
  // Access store values
...
export default DeleteSystemGlobalDropdownDialog;
